<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="SupplierMaster.aspx.cs" Inherits="MasterSetUp_SupplierMaster" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Supplier Setup %>"
                                ...
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlList" runat="server">
                                        <asp:Panel ID="pnlSearchRecords" runat="server" DefaultButton="btnbind">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                Width="170px">
                                                                <asp:ListItem Text="<%$ Resources:Attendance, Supplier Id %>" Value="Supplier_Id"></asp:ListItem>
                                                                <asp:ListItem Text="<%$ Resources:Attendance, Supplier Name %>" Value="Contact_Name"
                                                                    Selected="True"></asp:ListItem>
                                                                <asp:ListItem Text="<%$ Resources:Attendance, Supplier Name(Local) %>" Value="Contact_Name_L"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td width="135px">
                                            ...
                                            <asp:GridView ID="GvSupplier" PageSize="10" runat="server" AutoGenerateColumns="False"
                                                Width="100%" AllowPaging="True" OnPageIndexChanging="GvSupplier_PageIndexChanging"
                                                AllowSorting="True" OnSorting="GvSupplier_Sorting" CssClass="grid">
                                                <AlternatingRowStyle CssClass="InvgridAltRow" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Supplier_Id") %>'
                                                    ...
                                                    <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Supplier_Id") %>'
                                                                ImageUrl="~/Images/Erase.png" OnCommand="IbtnDelete_Command" Width="16px" ToolTip="<%$ Resources:Attendance,Delete %>" />
                                                        </ItemTemplate>
                                                        <ItemStyle CssClass="grid" HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="Supplier_Id" HeaderText="<%$ Resources:Attendance,Supplier Id %>"
                                                        SortExpression="Supplier_Id" ItemStyle-CssClass="grid" />
                                                    <asp:BoundField DataField="Contact_Name" HeaderText="<%$ Resources:Attendance,Supplier Name %>"
                                                        SortExpression="Contact_Name" ItemStyle-CssClass="grid" />
                                                    <asp:BoundField DataField="Contact_Name_L" HeaderText="<%$ Resources:Attendance,Supplier Name(Local) %>"
                                                    ...
                                                    <asp:BoundField DataField="Purchase_Limit" HeaderText="<%$ Resources:Attendance,Purchase Limit %>"
                                                        SortExpression="Purchase_Limit" ItemStyle-CssClass="grid" />
                                                </Columns>
                                        ...
                                        <table width="100%" style="padding-left: 43px">
                                            <tr>
                                                ...
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>' colspan="4">
                                                    <asp:TextBox ID="txtSupplierName" runat="server" CssClass="textComman" Width="713px"
                                                        BackColor="#c3c3c3" />
                                            ...
                                            <tr>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblLSupplierName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Supplier Name(Local) %>" />
                                                </td>
                                                <td align="center">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>' colspan="4">
                                                    <asp:TextBox ID="txtLSupplierName" runat="server" CssClass="textComman" Width="713px"
                                                        BackColor="#c3c3c3" />
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblPurchaseLimit" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Purchase Limit %>" />
                                                </td>
                                                <td>
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtPurchaseLimit" runat="server" CssClass="textComman" />
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblReturnDays" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Return Days %>" />
                                                </td>
                                                <td>
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtReturnDays" runat="server" CssClass="textComman" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" align="center" style="padding-left: 10px">
                                                    <table>
                                                        <tr>
                                                            <td width="90px">
                                                                <asp:Button ID="btnSupplierSave" runat="server" Text="<%$ Resources:Attendance,Save %>"
                                                                    CssClass="buttonCommman" Visible="false" OnClick="btnSupplierSave_Click" />
                                                            </td>
                                                            <td width="90px">
                                                            ...
                                                            <td width="90px">
                                                                <asp:Button ID="btnSupplierCancel" runat="server" CssClass="buttonCommman" Text="<%$ Resources:Attendance,Cancel %>"
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server" DefaultButton="btnbindBin">
                                        ...
                                        <asp:GridView ID="GvSupplierBin" PageSize="10" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvSupplierBin_PageIndexChanging"
                                            OnSorting="GvSupplierBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Customer Id%>" SortExpression="Customer_Id">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvSupplierId" runat="server" Text='<%# Eval("Supplier_Id") %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Customer Name %>" SortExpression="Contact_Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvSupplierName" runat="server" Text='<%# Eval("Contact_Name") %>' />
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                                                    <ItemTemplate>
                                                                                        <asp:ImageButton ID="imgBtnCompanyAddressEdit" runat="server" CommandArgument='<%# Eval("Trans_Id") %>'
                                                                                            ...
                                                                                            OnCommand="imgBtnCompanyAddressEdit_Command" />
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle CssClass="grid" HorizontalAlign="Center" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                                                    <ItemTemplate>
                                                                                        <asp:ImageButton ID="imgBtnCompanyAddressDelete" runat="server" CommandArgument='<%# Eval("Trans_Id") %>'
                                                                                            ...
                                                                                            OnCommand="imgBtnCompanyAddressDelete_Command" />
                                                                                    </ItemTemplate>
                                                                                    <ItemStyle CssClass="grid" HorizontalAlign="Center" />
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,S No. %>">
