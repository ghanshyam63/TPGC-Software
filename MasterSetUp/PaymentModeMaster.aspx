<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="PaymentModeMaster.aspx.cs" Inherits="Master_PaymentModeMaster" Title="Payment Mode Master" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Payment Mode Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="150px">
                                                        <asp:Label ID="lblPaymentModeName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Payment Mode Name %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtPaymentModeName" runat="server" Font-Names="Verdana" AutoPostBack="true"  OnTextChanged="txtPaymentModeName_TextChanged"
                                                            CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="autoComplete1" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionListPaymentMode" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtPaymentModeName"
                                                            UseContextKey="True" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem"
                                                            CompletionListHighlightedItemCssClass="itemHighlighted">
                                                        </cc1:AutoCompleteExtender>
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblPaymentModeNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Payment Mode Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtPaymentModeNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:GridView ID="GvPaymentMode" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvPaymentMode_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvPaymentMode_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Pay_Mode_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Pay_Mode_Id") %>'
                                                ...
                                                <asp:BoundField DataField="Pay_Mod_Name" HeaderText="<%$ Resources:Attendance,Payment Mode Name %>"
                                                    SortExpression="Pay_Mod_Name" ItemStyle-CssClass="grid" />
                                                <asp:BoundField DataField="Pay_Mod_Name_L" HeaderText="<%$ Resources:Attendance,Payment Mode Name(Local) %>"
                                                    SortExpression="Pay_Mod_Name_L" ItemStyle-CssClass="grid" />
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="GvPaymentModeBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvPaymentModeBin_PageIndexChanging"
                                            OnSorting="GvPaymentModeBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                               ...
                                               <asp:TemplateField HeaderText="<%$ Resources:Attendance,Payment Mode Id %>" SortExpression="Pay_Mode_Id">
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Payment Mode Name(Local) %>" SortExpression="Pay_Mod_Name_L">
                                                    <ItemTemplate>
