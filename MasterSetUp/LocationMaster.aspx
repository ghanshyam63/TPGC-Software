<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="LocationMaster.aspx.cs" Inherits="MasterSetUp_LocationMaster" Title="Location Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="gvLocationMaster" />
        </Triggers>
        <ContentTemplate>
            <table width="100%">
                <tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Location Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlList" runat="server">
                                        ...
                                        <asp:GridView ID="gvLocationMaster" PageSize="<%# SystemParameter.GetPageSize() %>"
                                            runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" AllowSorting="True"
                                            CssClass="grid" OnPageIndexChanging="gvLocationMaster_PageIndexChanging" OnSorting="gvLocationMaster_OnSorting">
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Location_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Location_Id") %>'
                                        ...
                                        <table width="100%" style="padding-left: 43px">
                                            <tr>
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblLocationCode" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Location Code %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtLocationCode" Width="250px" runat="server" CssClass="textComman"
                                                        BackColor="#e3e3e3" />
                                                ...
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblLocationType" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Location Type %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtLocationType" Width="250px" runat="server" CssClass="textComman" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblLocationName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Location Name %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtLocationName" BackColor="#e3e3e3" Width="250px" runat="server" OnTextChanged="txtLocation_OnTextChanged" AutoPostBack="true"
                                                        CssClass="textComman" />
                                                ...
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblLocationNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Location Name(Local) %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtLocationNameL" Width="250px" runat="server" CssClass="textComman" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblParentLocation" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Parent Location Name %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:DropDownList ID="ddlParentLocation" Width="262px" runat="server" CssClass="textComman" />
                                                </td>
                                                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                ...
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtManagerName" BackColor="#e3e3e3" Width="250px" runat="server"
                                                        CssClass="textComman" />
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="gvLocationMasterBin" PageSize="<%# SystemParameter.GetPageSize() %>"
                                            ...
                                            OnSorting="gvLocationMasterBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlAddress1" runat="server" class="MsgOverlayAddress" Visible="False">
                                        <asp:Panel ID="pnlAddress2" runat="server" class="MsgPopUpPanelAddress" Visible="False">
                                            <asp:Panel ID="pnlAddress3" DefaultButton="btnAddressSave" runat="server" Style="width: 100%;
