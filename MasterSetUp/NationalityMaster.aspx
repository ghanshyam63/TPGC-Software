<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="NationalityMaster.aspx.cs" Inherits="Master_NationalityMaster" Title="Nationality Master" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Nationality Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="120px">
                                                        <asp:Label ID="lblNationalityName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Nationality Name %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtNationalityName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtNationalityName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblNationalityNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Nationality Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtNationalityNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:GridView ID="GvNationality" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvNationality_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvNationality_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Nationality_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Nationality_ID") %>'
                                                ...
                                                <asp:BoundField DataField="Nationality" HeaderText="<%$ Resources:Attendance,Nationality Name %>"
                                                    SortExpression="Nationality" ItemStyle-CssClass="grid" />
                                                <asp:BoundField DataField="Nationality_L" HeaderText="<%$ Resources:Attendance,Nationality Name(Local) %>"
                                                    SortExpression="Nationality_L" ItemStyle-CssClass="grid" />
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="pnlbinRefresh" runat="server" DefaultButton="btnRefreshBin">
                                                                <asp:ImageButton ID="btnRefreshBin" runat="server" CausesValidation="False" Height="25px"
                                                                    ImageUrl="~/Images/refresh.png" Visible="true"  OnClick="btnRefreshBin_Click" Width="25px" ToolTip="<%$ Resources:Attendance,Refresh %>">
                                                                </asp:ImageButton>
                                                            </asp:Panel>
                                                        </td>
                                        ...
                                        <asp:GridView ID="GvNationalityBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvNationalityBin_PageIndexChanging"
                                            OnSorting="GvNationalityBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
