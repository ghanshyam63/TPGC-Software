<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="QualificationMaster.aspx.cs" Inherits="Master_QualificationMaster" Title="Qualification Master" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Qualification Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="120px">
                                                        <asp:Label ID="lblQualificationName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Qualification Name %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtQualificationName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtQualificationName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblQualificationNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Qualification Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtQualificationNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td width="90px">
                                                                    <asp:Button ID="btnCSave" runat="server" Text="<%$ Resources:Attendance,Save %>"
                                                                        CssClass="buttonCommman" Visible="false" OnClick="btnCSave_Click" />
                                                                </td>
                                                                <td width="90px">
                                        ...
                                        <asp:GridView ID="GvQualification" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvQualification_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvQualification_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Qualification_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Qualification_ID") %>'
                                                            ImageUrl="~/Images/Erase.png" Visible="false" OnCommand="IbtnDelete_Command" Width="16px" ToolTip="<%$ Resources:Attendance,Delete %>" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="Qualification" HeaderText="<%$ Resources:Attendance,Qualification Name %>"
                                                    SortExpression="Qualification" ItemStyle-CssClass="grid" />
                                                <asp:BoundField DataField="Qualification_L" HeaderText="<%$ Resources:Attendance,Qualification Name(Local) %>"
                                                    SortExpression="Qualification_L" ItemStyle-CssClass="grid" />
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                                        ...
                                                        <td width="30px" align="center">
                                                            <asp:Panel ID="pnlimgBtnRestore" runat="server" DefaultButton="imgBtnRestore">
                                                                <asp:ImageButton ID="imgBtnRestore" Height="25px" Width="25px" CausesValidation="False"
                                                                    runat="server" ImageUrl="~/Images/active.png" OnClick="btnRestoreSelected_Click" Visible="false"
                                                                    ToolTip="<%$ Resources:Attendance, Active %>" />
                                                            </asp:Panel>
                                                        </td>
                                                        <td>
                                                            <asp:Panel ID="pnlImgbtnSelectAll" runat="server" DefaultButton="ImgbtnSelectAll">
                                                                <asp:ImageButton ID="ImgbtnSelectAll" runat="server" OnClick="ImgbtnSelectAll_Click" Visible="false"
                                        ...
                                        <asp:GridView ID="GvQualificationBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvQualificationBin_PageIndexChanging"
                                            OnSorting="GvQualificationBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
