<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="AddressCategory.aspx.cs" Inherits="Master_AddressCategory" Title="PegasusInventory" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <link href="../CSS_oiu/AJAX.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Address Category Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtAddressName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtAddressName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblAddressNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Address Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtAddressNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:GridView ID="GvAddressCategory" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvAddressCategory_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvAddressCategory_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Address_Category_ID") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Address_Category_ID") %>'
                                                ...
                                                <asp:BoundField DataField="Address_Category_ID" HeaderText="<%$ Resources:Attendance,Address Category Id %>"
                                                    SortExpression="Address_Category_ID" ItemStyle-CssClass="grid" />
                                                ...
                                                <asp:BoundField DataField="Address_Name_L" HeaderText="<%$ Resources:Attendance,Address Name(Local) %>"
                                                    SortExpression="Address_Name_L" ItemStyle-CssClass="grid" />
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="GvAddressCategoryBin" PageSize="1" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvAddressCategoryBin_PageIndexChanging"
                                            OnSorting="GvAddressCategoryBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
