<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="DepartmentMaster.aspx.cs" Inherits="MasterSetUp_DepartmentMaster" Title="Department Master" %>
   ...
   <link href="../CSS/InvStyle.css" rel="stylesheet" type="text/css" />
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            <table width="100%">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Department Setup %>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                Width="170px">
                                                                <asp:ListItem Selected="True" Text="<%$ Resources:Attendance,Department Name %>" Value="Dep_Name"></asp:ListItem>
                                        ...
                                        <asp:GridView ID="gvDepMaster" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Dep_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Dep_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Department Name(Local) %>" SortExpression="Dep_Name_L">
                                                    <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="<%$ Resources:Attendance,Parent Department Name %>" SortExpression="ParentDepartment">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Phone No. %>" SortExpression="Phone_No">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblConversion_Location" runat="server" Text='<%# Eval("Phone_No") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
             ...
             <tr>
                <td width="170px"align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblDeptName"  runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Department Name %>"></asp:Label>
                ...
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtDeptName" BackColor="#e3e3e3" Width="250px" runat="server" CssClass="textComman" OnTextChanged="txtDepName_OnTextChanged" AutoPostBack="true" />
            ...
            <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:Label ID="lblDeptNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Department Name(Local) %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtDeptNameL" Width="250px" runat="server" CssClass="textComman"  />
            ...
            <tr>
                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblParentDep" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Parent Department Name %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                     <asp:DropDownList ID="ddlParentDep" Width="262px" runat="server"  CssClass="textComman" />
                 
                </td>
                 <td width="170px"align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblDeptCode" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Department Code %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtDeptCode"  Width="250px" runat="server" CssClass="textComman" BackColor="#e3e3e3" />
             ...
             <tr>
                ...
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                   <asp:TextBox ID="txtManagerName" BackColor="#e3e3e3" Width="250px" runat="server" CssClass="textComman"  />
                  <cc1:AutoCompleteExtender ID="AutoCompleteExtender5" runat="server" DelimiterCharacters=""
                   ...
                   <td width="170px"align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblPhoneNo" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Phone No. %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                   <asp:TextBox ID="txtPhoneNo"  Width="250px" runat="server" CssClass="textComman"  />
            ...
            <tr>
                <td width="170px"align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblFax" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Fax No. %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                   <asp:TextBox ID="txtFax"  Width="250px" runat="server" CssClass="textComman"  />
