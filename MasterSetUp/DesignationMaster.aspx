<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="DesignationMaster.aspx.cs" Inherits="Master_DesignationMaster" Title="Designation Master" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Designation Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="120px">
                                                        <asp:Label ID="lblDesignationName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Designation Name %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtDesignationName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtDesignationName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="AutoComplete1" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionListDesg" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtDesignationName"
                                                            UseContextKey="True" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem"
                                                            CompletionListHighlightedItemCssClass="itemHighlighted">
                                                        </cc1:AutoCompleteExtender>
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblDesignationNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Designation Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtDesignationNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:GridView ID="GvDesignation" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvDesignation_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvDesignation_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Designation_Id") %>'
                                                            ImageUrl="~/Images/edit.png" OnCommand="btnEdit_Command" CausesValidation="False" Visible="false" 
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Designation_ID") %>'
                                                ...
                                                <asp:BoundField DataField="Designation" HeaderText="<%$ Resources:Attendance,Designation Name %>"
                                                    SortExpression="Designation" ItemStyle-CssClass="grid" />
                                                <asp:BoundField DataField="Designation_L" HeaderText="<%$ Resources:Attendance,Designation Name(Local) %>"
                                                    SortExpression="Designation_L" ItemStyle-CssClass="grid" />
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldNameBin" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                Width="170px">
                                                                <asp:ListItem Text="<%$ Resources:Attendance, Designation Name%>" Value="Designation" />
                                                                <asp:ListItem Text="<%$ Resources:Attendance, Designation Name(Local) %>" Value="Designation_L"
                                                                     />
                                                                      <asp:ListItem Text="<%$ Resources:Attendance,Designation Id %>" Value="Designation_Id"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        ...
                                                        <td width="30px" align="center">
                                                            <asp:Panel ID="pnlimgBtnRestore" runat="server" DefaultButton="imgBtnRestore">
                                                                <asp:ImageButton ID="imgBtnRestore" Height="25px" Width="25px" CausesValidation="False"
                                                                    runat="server" ImageUrl="~/Images/active.png" OnClick="btnRestoreSelected_Click"
                                        ...
                                        <asp:GridView ID="GvDesignationBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvDesignationBin_PageIndexChanging"
                                            OnSorting="GvDesignationBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                               ...
                                               <asp:TemplateField HeaderText="<%$ Resources:Attendance,Designation Id %>" SortExpression="Designation_Id">
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Designation Name(Local) %>" SortExpression="Designation_L">
                                                    <ItemTemplate>
