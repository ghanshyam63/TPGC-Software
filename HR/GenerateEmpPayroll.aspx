<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="GenerateEmpPayroll.aspx.cs" Inherits="HR_GenerateEmpPayroll" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td width="150px" style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Generate Payroll %>"
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>' colspan="4">
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnGenratePayroll" runat="server" CssClass="buttonCommman"
                                                                        TabIndex="8" Text="<%$ Resources:Attendance,Generate Payroll %>" ValidationGroup="leavesave"
                                                                        Width="130px" OnClick="btnGenratePayroll_Click" />
                                                                </td>
                                                                <td>
                                                                </td>
                                                                 <td align='<%= Common.ChangeTDForDefaultLeft()%>' colspan="4">
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnpostpayroll" runat="server" CssClass="buttonCommman"
                                                                        TabIndex="8" Text="<%$ Resources:Attendance,Post Payroll %>" ValidationGroup="leavesave"
                                                                        Width="130px" OnClick="btnpostpayroll_Click" />
                                                                </td>
