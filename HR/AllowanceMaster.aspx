<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="AllowanceMaster.aspx.cs" Inherits="HRSetup_AllowanceMaster" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Allowance Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                ...
                                                <tr>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="120px">
                                                        <asp:Label ID="lblAllowanceName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Allowance Name %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtAllowanceName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtAllowanceName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:Label ID="lblAllowanceNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Allowance Name(Local) %>" />
                                                    </td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtAllowanceNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <asp:GridView ID="GvAllowance" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Allowance_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Allowance_Id") %>'
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="50px" align="center">
                                                            <asp:ImageButton ID="btnbindBin" runat="server" CausesValidation="False" Height="25px"
                                                                ...
                                                                ToolTip="<%$ Resources:Attendance,Search %>" onclick="btnbindBin_Click">
                                                            </asp:ImageButton>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="pnlImgbtnSelectAll" runat="server" DefaultButton="ImgbtnSelectAll">
                                                                <asp:ImageButton ID="ImgbtnSelectAll" runat="server" 
                                                                    ...
                                                                    ImageUrl="~/Images/selectAll.png" onclick="ImgbtnSelectAll_Click" />
                                                            </asp:Panel>
                                                        </td>
                                                        <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                        ...
                                        <asp:GridView ID="GvAllowanceBin" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvAllowanceBin_PageIndexChanging"
                                            OnSorting="GvAllowanceBin_Sorting" AllowSorting="true" 
                                            CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
