<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="PayEmployeeClaim.aspx.cs" Inherits="Arca_Wing_Pay_Employee_Claim" Title="Untitled Page" %>
                                ...
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlEmployeeLeave" runat="server" Visible="false">
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    <asp:TextBox ID="TxtClaimName" runat="server" Width="440px" TabIndex="1" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                      ...
                                      <asp:Panel ID="PanelSearchList" runat="server" Width="100%">
                                        ...
                                        <asp:GridView ID="GridViewClaimList" AllowSorting="true" runat="server" 
                                              AllowPaging="True" AutoGenerateColumns="False"
                                            CssClass="grid" Width="100%" DataKeyNames="Emp_Id" 
                                            PageSize="<%# SystemParameter.GetPageSize() %>" 
                                              onpageindexchanging="GridViewPenaltyList_PageIndexChanging" onsorting="GridViewPenaltyList_Sorting" 
                                            >
                                            <Columns>
                                            <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Claim_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Claim_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Claim Name %>" SortExpression="Claim_Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblPenaltynameList" runat="server" Text='<%# Eval("Claim_Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                        ...
                                        <asp:HiddenField ID="HdfSort" runat="server" />
                                         <asp:Panel ID="PanelUpdateClaim" runat="server" Width="100%" Visible="false">
                                                        <table width="100%">
                                                            <tr>
                                                                <td style="padding-top: 5px;">
                                                                </td>
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td colspan="4" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    <asp:TextBox ID="txtEmployeeId" runat="server" Width="440px" TabIndex="1" CssClass="textComman" ReadOnly="true"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                              <tr>
                                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>" width="104">
                                                                ...
                                                                <td colspan="4" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    <asp:TextBox ID="TxtEmployeeName" runat="server" Width="440px" ReadOnly="true" TabIndex="1" CssClass="textComman"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>" width="104">
                                                                    <asp:Label ID="LblPenaltynameList" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Claim Name %>"></asp:Label>
                                                                </td>
                                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    :
                                                                </td>
                                                                <td colspan="4" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    <asp:TextBox ID="TxtClaimNameList" runat="server" Width="440px" TabIndex="1" CssClass="textComman"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    <asp:Label ID="Lbllist" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Claim Description %>"></asp:Label>
                                                                </td>
                                                                <td valign="top" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                    :
                                                                </td>
                                                                <td colspan="4" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                                    <asp:TextBox ID="TxtClaimDiscList" runat="server" Width="440px" Height="70px"
                                                                        TextMode="MultiLine" TabIndex="2" CssClass="textComman"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <asp:RadioButton ID="RbtnApproved" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Approved %>"
                                                                    TabIndex="7" GroupName="Loan"   />
                                                            <asp:RadioButton ID="RbtnCancelled" runat="server" TabIndex="8" CssClass="labelComman"
                                                                    Text="<%$ Resources:Attendance,Cancelled %>" GroupName="Loan" 
                                                                     />
                                                            ...
                                                            <tr>
                                                                <td colspan="6" align="center" style="padding-left: 12px;">
                                                                    <asp:Button ID="BtnUpdate" runat="server" CssClass="buttonCommman" TabIndex="9" Text="<%$ Resources:Attendance,Update %>"
