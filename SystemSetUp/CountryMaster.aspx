<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="CountryMaster.aspx.cs" Inherits="MasterSetUp_CountryMaster" Title="Country Master" %>
   ...
   <link href="../CSS/InvStyle.css" rel="stylesheet" type="text/css" />
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="gvCountryMaster" />
        </Triggers>
        <ContentTemplate>
            <table width="100%">
                <tr >
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="0" bordercolor="#F0F0F0">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Country Setup %>"
                            ...
                            <tr>
                               ...
                               <asp:GridView ID="gvCountryMaster" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server"
                                            AutoGenerateColumns="False" Width="100%" AllowPaging="True" AllowSorting="True"
                                            CssClass="grid" OnPageIndexChanging="gvCountryMaster_PageIndexChanging" OnSorting="gvCountryMaster_OnSorting">
                                            <Columns>
                                               <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Country_Id") %>'
                                                 ...
                                                 <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Country_Id") %>'
            ...
            <tr>
                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblCountryCode" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Country Code %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtCountryCode"  Width="250px" TabIndex ="101" runat="server" CssClass="textComman" BackColor="#e3e3e3" />
             ...
             <tr>
                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblCountryName"  runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Country Name %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtCountryName" TabIndex ="104" BackColor="#e3e3e3" Width="250px" runat="server" CssClass="textComman" AutoPostBack="true" OnTextChanged="txtCountryName_TextChanged"  />
             ...
             <tr>
                <td width="170px" align='<%= Common.ChangeTDForDefaultLeft()%>' >
                    <asp:Label ID="lblCountryNameL" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Country Name(Local) %>"></asp:Label>
                </td>
                <td width="1px">
                    :
                </td>
                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                    <asp:TextBox ID="txtCountryNameL" TabIndex ="105" Width="250px" runat="server" CssClass="textComman"  />
            ...
            <tr>
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="gvCountryMasterBin" PageSize="<%# SystemParameter.GetPageSize() %>"
                                            runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" OnPageIndexChanging="gvCountryMasterBin_PageIndexChanging"
                                            OnSorting="gvCountryMasterBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
