<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="VillageMaster.aspx.cs" Inherits="MasterSetUp_VillageMaster" Title="Village Master" %>
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtVillageName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtVillageName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="autoComplete1" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionListVillage" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtVillageName"
                                                            UseContextKey="True" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem"
                                                            CompletionListHighlightedItemCssClass="itemHighlighted">
                                                        </cc1:AutoCompleteExtender>
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        Village Name (Local)</td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtVillageNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                ...
                                                                <asp:ListItem>Village Name Local</asp:ListItem>
                                                                <asp:ListItem>Village Id</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td width="135px">
                                        ...
                                        <asp:GridView ID="GvVillage" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvVillage_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvVillage_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Village_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Village_ID") %>'
                                                            ImageUrl="~/Images/Erase.png" OnCommand="IbtnDelete_Command" Visible="false"  Width="16px" ToolTip="<%$ Resources:Attendance,Delete %>" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Village Id" SortExpression="Village_Id">
                                                    <ItemTemplate>
                                        
                                                        <asp:Label ID="lblDesigId1"  runat="server" Text='<%# Eval("Village_Id") %>'></asp:Label>
                                                ...
                                                <asp:BoundField DataField="Village" HeaderText="Village"
                                                    SortExpression="Village" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Village_L" HeaderText="Village_L"
                                                    SortExpression="Village_L" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="GvVillageBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvVillageBin_PageIndexChanging"
                                            OnSorting="GvVillageBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                               ...
                                               <asp:TemplateField HeaderText="Village Id" SortExpression="Village_Id">
                                                ...
                                                <asp:TemplateField HeaderText="Village Name" SortExpression="Village">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvVillageName" runat="server" Text='<%# Eval("Village") %>'></asp:Label>
                                                        <asp:Label ID="lblVillageId" Visible="false"  runat="server" Text='<%# Eval("Village_Id") %>'></asp:Label>
                                                        
                                                        
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Village Name(Local)" SortExpression="Village_L">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvVillageNameL" runat="server" Text='<%# Eval("Village_L") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                            </Columns>
