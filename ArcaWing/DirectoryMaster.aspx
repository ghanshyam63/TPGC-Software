<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="DirectoryMaster.aspx.cs" Inherits="New_ArcWing_DirectoryMaster" Title="Untitled Page" %>
                                ...
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    ...
                                    <asp:Panel ID="PnlNewEdit" runat="server" DefaultButton="btnSave">
                                        <table width="100%" style="padding-left: 43px">
                                            <tr>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblDirName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Directory Name %>"></asp:Label>
                                                </td>
                                                <td style="width: 1px;">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtDirectName" BackColor="#e3e3e3" Width="250px" runat="server"
                                                        CssClass="textComman" />
                                                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" DelimiterCharacters=""
                                                        Enabled="True" ServiceMethod="GetCompletionListDirectoryName" ServicePath=""
                                                        CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtDirectName"
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="gvDirMasterBin" PageSize="<%# SystemParameter.GetPageSize() %>"
