...
public class Inv_SalesInquiryDetail
{
    ...
    public int UpdateSIDetail(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strTrans_Id, string strSInquiryID, string strSerial_No, string strProduct_Id, string strUnitId, string strProductDescription, string strCurrency_Id, string strEstimatedUnitPrice, string strQuantity, string strPost, string strField1, string strField2, string strField3, string strField4, string strField5, string strField6, string strField7, string strIsActive, string strModifiedBy, string strModifiedDate)
    {
        ...
        paramList[8] = new PassDataToSql("@ProductDescription", strProductDescription, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetSIDetailAllTrue(string strCompany_Id, string strBrand_Id, string strLocation_Id)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Inv_SalesInqDetail_SelectRow", paramList);
        return dtInfo;
    }
    public DataTable GetSIDetailAllFalse(string strCompany_Id, string strBrand_Id, string strLocation_Id)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetSIDetailByTrans_Id(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strTrans_Id)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetSIDetailBySInquiryId(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strSInquiryID)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetSIDetailBySerial_No(string strCompany_Id, string strBrand_Id, string strLocation_Id, string strSerialNo)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[7];
        paramList[0] = new PassDataToSql("@Company_Id", strCompany_Id, PassDataToSql.ParaTypeList.Nvarchar, PassDataToSql.ParaDirectonList.Input);
