...
public class RoleMaster
{
    ...
    public int DeleteRoleMaster(string CompanyId, string RoleId, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@Role_Id", RoleId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetRoleMasterById(string CompanyId, string RoleId)
    {
        ...
        dtInfo = daClass.Reuturn_Datatable_Search("sp_Set_RoleMaster_SelectRow", paramList);
