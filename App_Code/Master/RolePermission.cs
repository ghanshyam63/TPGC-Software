...
public class RolePermission
{
    ...
    public RolePermission()
    {
        ...
        public int InsertRoleOpPermission(string Ref_Id,string Op_Add,string Op_Edit,string Op_Delete,string Op_Restore ,string Op_View ,string Op_Print,string  Op_Download,string Op_Upload)
        {
