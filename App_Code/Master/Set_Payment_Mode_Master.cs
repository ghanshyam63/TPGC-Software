...
public class Set_Payment_Mode_Master
{
	...
	public Set_Payment_Mode_Master()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public int InsertPaymentModeMaster(string CompanyId, string EPay_ModName, string LPay_ModName, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
    ...
    public int UpdatePaymentModeMaster(string CompanyId, string Pay_ModId, string EPay_ModName, string LPay_ModName, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string ModifiedBy, string ModifiedDate)
    {
        ...
        paramList[14] = new PassDataToSql("@Pay_Mode_Id", Pay_ModId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetPaymentModeMasterById(string CompanyId, string Pay_ModId)
    {
    ...
    public DataTable GetPaymentModeMaster(string CompanyId)
    {
    ...
    public DataTable GetPaymentModeMasterInactive(string CompanyId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetPaymentModeMasterByPaymentModeName(string CompanyId, string strPay_ModName)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@Company_Id", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
