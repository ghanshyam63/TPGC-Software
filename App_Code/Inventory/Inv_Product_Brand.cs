...
public class Inv_Product_Brand
{
    ...
    public Inv_Product_Brand()
    {
        //
        // TODO: Add constructor logic here
        //
    }
    public int InsertProductBrand(string CompanyId, string ProductId, string PBrandId, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string IsActive, string CreatedBy, string CreatedDate, string ModifiedBy, string ModifiedDate)
    {
        ...
        daClass.execute_Sp("sp_Inv_Product_Brand_Insert", paramList);
        return Convert.ToInt32(paramList[15].ParaValue);
    }
    public int DeleteProductBrand(string CompanyId, string ProductId)
    {
        ...
        daClass.execute_Sp("sp_Inv_Product_Brand_Delete", paramList);
    ...
    public DataTable GetDataProductId(string CompanyId, string ProductId)
    {
        ...
        paramList[0] = new PassDataToSql("@CompanyId", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[1] = new PassDataToSql("@ProductId", ProductId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
        paramList[2] = new PassDataToSql("@BrandId", "0", PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
    ...
    public DataTable GetDataBrandId(string CompanyId, string BrandId)
    {
        DataTable dtInfo = new DataTable();
        PassDataToSql[] paramList = new PassDataToSql[4];
        paramList[0] = new PassDataToSql("@CompanyId", CompanyId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
