...
public class Inv_ProductLedger
{
    ...
    public int InsertProductLedger(string CompanyId, string BrnadId, string LocationId, string TransType, string TransTypeId, string ToLocationId, string ProductId, string UnitId, string InOut, string LotNo, string BatchNo, string QuantityIn, string QuantityOut, string SDate, string UnitPrice, string ExpiryDate, string SerialNo, string ManufacturerDate, string Barcode, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate)
    {
    ...
    public int UpdateProductLedger(string CompanyId, string BrnadId, string LocationId, string TransId, string TransType, string ToLocationId, string TransTypeId, string ProductId, string UnitId, string InOut, string LotNo, string BatchNo, string QuantityIn, string QuantityOut, string UnitPrice, string SDate, string ExpiryDate, string SerialNo, string ManufacturerDate, string Barcode, string Field1, string Field2, string Field3, string Field4, string Field5, string Field6, string Field7, string strIsActive, string strCreatedBy, string strCreatedDate, string strModifiedBy, string strModifiedDate)
    {
        ...
        paramList[9] = new PassDataToSql("@QuantityIn ", QuantityIn, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        ...
        paramList[27] = new PassDataToSql("@UnitPrice", UnitPrice, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);

        paramList[28] = new PassDataToSql("@SDate", SDate, PassDataToSql.ParaTypeList.Date, PassDataToSql.ParaDirectonList.Input);
        paramList[29] = new PassDataToSql("@QuantityOut", QuantityOut, PassDataToSql.ParaTypeList.Float, PassDataToSql.ParaDirectonList.Input);
        paramList[30] = new PassDataToSql("@ToLocationId", ToLocationId, PassDataToSql.ParaTypeList.Int, PassDataToSql.ParaDirectonList.Input);
