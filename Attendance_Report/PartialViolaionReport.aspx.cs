...
public partial class AttendanceReport_PartialViolaionReport : System.Web.UI.Page
{
    ...
    public void GetReport()
    {
        ...
        else
        {
            ...
            dtFilter = new DataView(dtFilter, "Partial_Violation_Min<>0", "", DataViewRowState.CurrentRows).ToTable();
