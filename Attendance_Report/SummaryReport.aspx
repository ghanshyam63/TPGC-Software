<%@ Page Language="C#"    MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"  CodeFile="SummaryReport.aspx.cs" Inherits="AttendanceReports_SummaryReport" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Attendance Summary Report  %>"
...
<table width="100%">
 ...
 <asp:Panel ID="pnlReport" runat="server" >
                        ...
                        <tr>
                            <td>
                                <asp:Panel ID="pnlrptviewer" runat="server" Width="1000px" ScrollBars="Auto"  Height="100%">
