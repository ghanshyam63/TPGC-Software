...
public partial class AttendanceReport_PartialLeaveReport : System.Web.UI.Page
{
    ...
    public void GetReport()
    {
        ...
        else
        {
            ...
            adp.Fill(rptdata.sp_Att_PartialLeave_Request_Report,int.Parse(Session["CompId"].ToString()), Convert.ToDateTime(FromDate), Convert.ToDateTime(ToDate));
