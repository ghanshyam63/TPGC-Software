<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true"
    CodeFile="DeleteUser.aspx.cs" Inherits="Device_DeleteUser" Title="Untitled Page" %>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" bordercolor="#F0F0F0">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Delete User Setup %>"
                            ...
                            <tr>
                                ...
                                <table width="100%">
                                 ...
                                 <tr>
                                                <td runat="server" visible="false" align='<%= Common.ChangeTDForDefaultLeft()%>' style="width: 192px">
                                                ...
                                                <td style="padding-left:15px;" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                        ...
                                        <asp:Panel ID="pnlManage" runat="server" BorderColor="#CCCCCC">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <asp:Label ID="Label8" CssClass="labelComman" runat="server" Text="<%$ Resources:Attendance,Delete With%>"></asp:Label>
                                                </td>
                                                <td width="1%">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                      <asp:CheckBox CssClass="labelComman"  ID="chkUser" runat="server" Text="<%$ Resources:Attendance,User%>" />
                                                ...
                                                <td   style="padding-left:10px;" align="<%= Common.ChangeTDForDefaultLeft()%>" valign="middle" colspan="3">
                                                    <asp:Button ID="btnSaveSelected" Width="200px" runat="server" CssClass="buttonCommman" OnClick="btnDeleteSelected_Click"
                                                        Text="<%$ Resources:Attendance,Delete Selected Record%>" />
                                                    &nbsp;
                                                </td>
                                            </tr>   
                                                    <tr>
