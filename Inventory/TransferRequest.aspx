<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="TransferRequest.aspx.cs" Inherits="Inventory_TransferRequest" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnProductCancel" />
            <asp:PostBackTrigger ControlID="btnBin" />
          <%--  <asp:PostBackTrigger ControlID="gvTransferRequest" />--%>
        ...
        <ContentTemplate>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Transfer Request %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlList" runat="server">
                                        ...
                                        <asp:GridView ID="gvTransferRequest" PageSize="<%# SystemParameter.GetPageSize() %>"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Transfer Request Date %>" SortExpression="TDate">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRequestDate" runat="server" Text='<%# Convert.ToDateTime(Eval("TDate").ToString()).ToString("dd-MMM-yyyy") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Request Location %>"
                                                 ...
                                                 <asp:TemplateField HeaderText="<%$ Resources:Attendance,Post %>"
                                                  ...
                                                  <asp:TemplateField HeaderText="<%$ Resources:Attendance,Status %>"
                                                   >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# GetStatus(Eval("Status").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                        ...
                                        <table width="100%" style="padding-left: 43px">
                                            <tr>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblRequestdate" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Transfer Request Date %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtRequestdate" runat="server" CssClass="textComman" 
                                                        AutoPostBack="True" ontextchanged="txtRequestdate_TextChanged" />
                                                ...
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtlRequestNo" runat="server" CssClass="textComman"
                                                        /></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:Label ID="lblExpDelDate" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Request Location %>"></asp:Label>
                                                </td>
                                                <td width="1px">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtLocationName" BackColor="#e3e3e3" AutoPostBack="true"  Width="250px" runat="server" 
                                                        CssClass="textComman" OnTextChanged="txtLocationName_TextChanged" />
                                                ...
                                                <td colspan="2">
                                                <asp:CheckBox ID="ChkPost" runat="server" Text="<%$ Resources:Attendance,Post %>" CssClass="labelComman" />
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="gvBinTransferRequest" PageSize="<%# SystemParameter.GetPageSize() %>"
                                            runat="server" AutoGenerateColumns="False" Width="100%" AllowPaging="True" AllowSorting="True"
                                            CssClass="grid" OnPageIndexChanging="gvBinTransferRequest_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Request Location %>"
                                                    SortExpression="Location_Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLocationBin" runat="server" Text='<%# Eval("Location_Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="<%$ Resources:Attendance,Post %>"
            ...
            <asp:Panel ID="pnlProduct1" runat="server" class="MsgOverlayAddress" Visible="False">
                <asp:Panel ID="pnlProduct2" runat="server" class="MsgPopUpPanelAddress" Visible="False">
                    ...
                    <tr>
                               <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                   <asp:Label ID="lblPDescription" runat="server" CssClass="labelComman" Visible="false" Text="<%$ Resources:Attendance,Unit Cost %>" />
                             ...
                             <tr>
                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                    <asp:Label ID="Label1" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Product Description %>" />
                                </td>
                                <td align="center">
                                    :
                                </td>
