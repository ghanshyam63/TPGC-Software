<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="RackMaster.aspx.cs" Inherits="Inventory_RackMaster" Title="Untitled Page" %>
 ...
 <link href="../App_Themes/AJAX.css" rel="stylesheet" type="text/css" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="gvRackMaster" />
            <asp:PostBackTrigger ControlID="gvRackMasterBin" />
            <asp:PostBackTrigger ControlID="txtRackName" />
        </Triggers>
        <ContentTemplate>
            <table width="100%">
                <tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Rack Setup %>"
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="PnlList" runat="server">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                ...
                                                                <asp:ListItem Text="<%$ Resources:Attendance,Rack Name %>" Value="Rack_Name"
                                            ...
                                            <asp:Panel ID="panelPopUpPanel" runat="server" class="PopUpPanel" Visible="false">
                                                    ...
                                                    <tr>
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            <asp:Label ID="lblDeletePanelHeader" runat="server" Font-Size="14px" Font-Bold="true"
                                                                CssClass="labelComman" Text="<%$ Resources:Attendance, Delete Rack %>"></asp:Label>
                                                        </td>
                                                        <td align="right">
                                                ...
                                                <table border="0" width="400px" bgcolor="#ccddee">
                                                    <tr id="trgv" runat="server" visible="false">
                                                        <td>
                                                            <asp:Label ID="Label1" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Rack Id%>"></asp:Label>
                                                        </td>
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            :
                                                        </td>
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            <asp:Label ID="lblDelRackId" runat="server" CssClass="labelComman" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label2" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,rack Name%>"></asp:Label>
                                                        </td>
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            :
                                                        </td>
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            <asp:Label ID="lblDelRackName" runat="server" CssClass="labelComman" />
                                                        </td>
                                                    </tr>
                                                    <tr id="rowDelParentRack" runat="server">
                                                        <td>
                                                        ...
                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                            <asp:Label ID="lblDelParentrack" runat="server" CssClass="labelComman" />
                                                        </td>
                                                    </tr>
                                        ...
                                        <asp:GridView ID="gvRackMaster" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="gvRackMaster_PageIndexChanging"
                                            OnSorting="gvRackMaster_OnSorting" CssClass="grid" AllowSorting="true">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("Rack_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("Rack_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Parent Name %>" >
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblParentName" runat="server" Text='<%# GetParentRack(Eval("ParentRackId").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                            </Columns>
                                    ...
                                    <asp:Panel ID="PnlNewEdit" runat="server" DefaultButton="btnSave">
                                        <table width="100%" style="padding-left: 43px">
                                            <tr>
                                                ...
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:TextBox ID="txtRackName" runat="server" BackColor="#e3e3e3" OnTextChanged="txtRackName_TextChanged" CssClass="textComman"
                                                        AutoPostBack="true"  />
                                                    <cc1:AutoCompleteExtender ID="txtRackName_AutoCompleteExtender" runat="server"
                                                        DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionList" ServicePath=""
                                                        CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtRackName"
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblLRackName" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Rack Name(Local) %>"></asp:Label>
                                                </td>
                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                    :
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtLRackName" runat="server" Width="250px" CssClass="textComman" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblPerentRack" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Parent Rack %>" />
                                                </td>
                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                    :
                                                </td>
                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                    <asp:DropDownList ID="ddlPerentRack" runat="server" CssClass="textComman" Width="263px">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <asp:Panel ID="PnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="gvRackMasterBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="gvRackMasterBin_PageIndexChanging"
                                            OnSorting="gvRackMasterBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Rack Name(Local) %>" SortExpression="Rack_Name_L">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRackName_Local" runat="server" Text='<%# Eval("Rack_Name_L") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" HorizontalAlign="Center" />
                                                </asp:TemplateField>
