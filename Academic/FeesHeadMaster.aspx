<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="FeesHeadMaster.aspx.cs" Inherits="Academic_FeesHeadMaster" Title="Fees Head Master" %>
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtFeesHeadName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtFeesHeadName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="autoComplete1" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionListFeesHead" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtFeesHeadName"
                                                            UseContextKey="True" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem"
                                                            CompletionListHighlightedItemCssClass="itemHighlighted">
                                                        </cc1:AutoCompleteExtender>
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        FeesHead Name (Local)</td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtFeesHeadNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                Width="170px">
                                                                <asp:ListItem Value="FeesHead">FeesHead</asp:ListItem>
                                                                <asp:ListItem>FeesHead Name Local</asp:ListItem>
                                                                <asp:ListItem>FeesHead Id</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td width="135px">
                                        ...
                                        <asp:GridView ID="GvFeesHead" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvFeesHead_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvFeesHead_Sorting" CssClass="grid">
                                            <AlternatingRowStyle CssClass="InvgridAltRow" />
                                            <Columns>
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Edit %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnEdit" runat="server" CommandArgument='<%# Eval("FeesHead_Id") %>'
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="IbtnDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("FeesHead_ID") %>'
                                                            ImageUrl="~/Images/Erase.png" OnCommand="IbtnDelete_Command" Visible="false"  Width="16px" ToolTip="<%$ Resources:Attendance,Delete %>" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="FeesHead Id" SortExpression="FeesHead_Id">
                                                    <ItemTemplate>
                                        
                                                        <asp:Label ID="lblDesigId1"  runat="server" Text='<%# Eval("FeesHead_Id") %>'></asp:Label>
                                                        
                                                        
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="FeesHead" HeaderText="FeesHead"
                                                    SortExpression="FeesHead" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FeesHead_L" HeaderText="FeesHead_L"
                                                    SortExpression="FeesHead_L" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="GvFeesHeadBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvFeesHeadBin_PageIndexChanging"
                                            OnSorting="GvFeesHeadBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                               ...
                                               <asp:TemplateField HeaderText="FeesHead Id" SortExpression="FeesHead_Id">
                                                ...
                                                <asp:TemplateField HeaderText="FeesHead Name" SortExpression="FeesHead">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvFeesHeadName" runat="server" Text='<%# Eval("FeesHead") %>'></asp:Label>
                                                        <asp:Label ID="lblFeesHeadId" Visible="false"  runat="server" Text='<%# Eval("FeesHead_Id") %>'></asp:Label>
                                                        
                                                        
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="FeesHead Name(Local)" SortExpression="FeesHead_L">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvFeesHeadNameL" runat="server" Text='<%# Eval("FeesHead_L") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                            </Columns>
