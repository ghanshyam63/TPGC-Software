...
using System.Text;
public partial class Academic_ClassMaster : BasePage
{
    #region Defined Class Object
    Common cmn = new Common();
    SystemParameter objSys = new SystemParameter();
    ClassMaster objDesg = new ClassMaster();
    ...
    public void AllPageCode()
    {
        ...
        Session["HeaderText"] = "Academic Setup";
    ...
    public void FillGridBin()
    {
        ...
        dt = objDesg.GetClassMasterInactive(Session["CompId"].ToString().ToString());
        GvClassBin.DataSource = dt;
        GvClassBin.DataBind();
        Session["dtBinClass"] = dt;
    ...
    {
        DataTable dtBrand = objDesg.GetClassMaster(Session["CompId"].ToString().ToString());
        lblTotalRecords.Text = Resources.Attendance.Total_Records + ": " + dtBrand.Rows.Count + "";
        Session["dtClass"] = dtBrand;
        Session["dtFilter"] = dtBrand;
        if (dtBrand != null && dtBrand.Rows.Count > 0)
        {
            GvClass.DataSource = dtBrand;
            GvClass.DataBind();
            AllPageCode();
        }
        else
    ...
    protected void IbtnRestore_Command(object sender, CommandEventArgs e)
    {
        ...
        b = objDesg.DeleteClassMaster(Session["CompId"].ToString().ToString(), editid.Value, true.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString());
        if (b != 0)
        {
    ...
    protected void GvClassBin_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        GvClassBin.PageIndex = e.NewPageIndex;
        ...
        for (int i = 0; i < GvClassBin.Rows.Count; i++)
        {
            Label lblconid = (Label)GvClassBin.Rows[i].FindControl("lblClassId");
            ...
            for (int j = 0; j < lblSelectedRecord.Text.Split(',').Length; j++)
            {
                if (lblSelectedRecord.Text.Split(',')[j] != "")
                {
                    ...
                    {
                        ((CheckBox)GvClassBin.Rows[i].FindControl("chkgvSelect")).Checked = true;
                    }
                }
            }
        }
    ...
    protected void GvClassBin_OnSorting(object sender, GridViewSortEventArgs e)
    {
    ...
    protected void btnEdit_Command(object sender, CommandEventArgs e)
    {
        ...
        DataTable dtTax = objDesg.GetClassMasterById(Session["CompId"].ToString().ToString(), editid.Value);

        btnNew.Text = Resources.Attendance.Edit;

        txtClassName.Text = dtTax.Rows[0]["Class"].ToString();
        txtClassNameL.Text = dtTax.Rows[0]["Class_L"].ToString();
        System.Web.UI.ScriptManager.GetCurrent(this).SetFocus(txtClassName);
    }
    ...
    protected void btnbindrpt_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ddlOption.SelectedIndex != 0)
        {
            ...
            DataTable dtCurrency = (DataTable)Session["dtClass"];
    ...
    protected void IbtnDelete_Command(object sender, CommandEventArgs e)
    {
        ...
        b = objDesg.DeleteClassMaster(Session["CompId"].ToString().ToString(), editid.Value, "false", Session["UserId"].ToString().ToString(), DateTime.Now.ToString());
        if (b != 0)
        {
    ...
    protected void btnbindBin_Click(object sender, EventArgs e)
    {
        ...
        if (ddlOptionBin.SelectedIndex != 0)
        {
            ...
            DataTable dtCust = (DataTable)Session["dtBinClass"];
            DataView view = new DataView(dtCust, condition, "", DataViewRowState.CurrentRows);
            Session["dtBinFilter"] = view.ToTable();
            lblTotalRecordsBin.Text = Resources.Attendance.Total_Records + " : " + view.ToTable().Rows.Count.ToString() + "";
            GvClassBin.DataSource = view.ToTable();
            GvClassBin.DataBind();
    ...
    {
        int Msg = 0;
        DataTable dt = objDesg.GetClassMasterInactive(Session["CompId"].ToString().ToString());

        if (GvClassBin.Rows.Count != 0)
        {
            if (lblSelectedRecord.Text != "")
            {
                for (int j = 0; j < lblSelectedRecord.Text.Split(',').Length; j++)
                {
                    if (lblSelectedRecord.Text.Split(',')[j] != "")
                    {
                        ...
                        Msg = objDesg.DeleteClassMaster(Session["CompId"].ToString().ToString(), lblSelectedRecord.Text.Split(',')[j].Trim().ToString(), true.ToString(), Session["UserId"].ToString(), DateTime.Now.ToString());
                    }
                }
            }
            ...
            {
                int fleg = 0;
                foreach (GridViewRow Gvr in GvClassBin.Rows)
                {
    ...
    {
        DataTable dtClass = (DataTable)Session["dtbinFilter"];
        ...
        if (ViewState["Select"] == null)
        {
            ...
            {
                if (!lblSelectedRecord.Text.Split(',').Contains(dr["Class_ID"]))
                {
                    lblSelectedRecord.Text += dr["Class_ID"] + ",";
                }
            }
            for (int i = 0; i < GvClassBin.Rows.Count; i++)
            {
        ...
        {
            lblSelectedRecord.Text = "";
            DataTable dtClass1 = (DataTable)Session["dtBinFilter"];
            GvClassBin.DataSource = dtClass1;
            GvClassBin.DataBind();
            ViewState["Select"] = null;
        }
    ...
    {
        CheckBox chkSelAll = ((CheckBox)GvClassBin.HeaderRow.FindControl("chkgvSelectAll"));
        for (int i = 0; i < GvClassBin.Rows.Count; i++)
        {
            ((CheckBox)GvClassBin.Rows[i].FindControl("chkgvSelect")).Checked = chkSelAll.Checked;
            if (chkSelAll.Checked)
            {
                if (!lblSelectedRecord.Text.Split(',').Contains(((Label)(GvClassBin.Rows[i].FindControl("lblClassId"))).Text.Trim().ToString()))
                {
                    lblSelectedRecord.Text += ((Label)(GvClassBin.Rows[i].FindControl("lblClassId"))).Text.Trim().ToString() + ",";
                }
            }
            else
            {
                ...
                {
                    if (item != ((Label)(GvClassBin.Rows[i].FindControl("lblClassId"))).Text.Trim().ToString())
                    {
                        if (item != "")
                        {
                            temp += item + ",";
    ...
    protected void chkgvSelect_CheckedChanged(object sender, EventArgs e)
    {
        ...
        Label lb = (Label)GvClassBin.Rows[index].FindControl("lblClassId");
        if (((CheckBox)GvClassBin.Rows[index].FindControl("chkgvSelect")).Checked)
        {
