<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="StudentMaster.aspx.cs" Inherits="Academic_StudentMaster" Title="Student Master" %>
                            ...
                            <tr>
                                <td bgcolor="#ccddee" colspan="4" width="100%" height="500px" valign="top">
                                    <asp:Panel ID="pnlList" runat="server">
                                            ...
                                            <table width="100%" style="padding-left: 43px; padding-top: 10px; padding-bottom: 20px">
                                                <tr>
                                                    ...
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>' width="270px">
                                                        <asp:TextBox ID="txtStudentName" runat="server" Font-Names="Verdana" AutoPostBack="true"
                                                            OnTextChanged="txtStudentName_TextChanged" CssClass="textComman" BackColor="#e3e3e3"></asp:TextBox>
                                                        <cc1:AutoCompleteExtender ID="autoComplete1" runat="server"
                                                            DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionListStudent" ServicePath=""
                                                            CompletionInterval="100" MinimumPrefixLength="1" CompletionSetCount="1" TargetControlID="txtStudentName"
                                                            UseContextKey="True" CompletionListCssClass="completionList" CompletionListItemCssClass="listItem"
                                                            CompletionListHighlightedItemCssClass="itemHighlighted">
                                                        </cc1:AutoCompleteExtender>
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        Student Name (Local)</td>
                                                    <td>
                                                        :
                                                    </td>
                                                    <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                        <asp:TextBox ID="txtStudentNameL" runat="server" CssClass="textComman"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="180px">
                                                            <asp:DropDownList ID="ddlFieldName" runat="server" CssClass="DropdownSearch" Height="25px"
                                                                ...
                                                                <asp:ListItem>Student Name Local</asp:ListItem>
                                        ...
                                        <asp:GridView ID="GvStudent" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvStudent_PageIndexChanging"
                                            AllowSorting="True" OnSorting="GvStudent_Sorting" CssClass="grid">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Delete %>">
                                                 ...
                                                 <asp:TemplateField HeaderText="Student Id" SortExpression="Student_Id">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblDesigId1"  runat="server" Text='<%# Eval("Student_Id") %>'></asp:Label>
                                                ...
                                                <asp:BoundField DataField="Student" HeaderText="Student"
                                                    SortExpression="Student" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Student_L" HeaderText="Student_L"
                                                    SortExpression="Student_L" ItemStyle-CssClass="grid" >
                                                    <ItemStyle CssClass="grid" />
                                                </asp:BoundField>
                                            </Columns>
                                    ...
                                    <asp:Panel ID="pnlBin" runat="server">
                                        ...
                                        <asp:GridView ID="GvStudentBin" PageSize="<%# SystemParameter.GetPageSize() %>" runat="server" AutoGenerateColumns="False"
                                            Width="100%" AllowPaging="True" OnPageIndexChanging="GvStudentBin_PageIndexChanging"
                                            OnSorting="GvStudentBin_OnSorting" AllowSorting="true" CssClass="grid">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                               ...
                                               <asp:TemplateField HeaderText="Student Id" SortExpression="Student_Id">
                                                ...
                                                <asp:TemplateField HeaderText="Student Name" SortExpression="Student">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvStudentName" runat="server" Text='<%# Eval("Student") %>'></asp:Label>
                                                        <asp:Label ID="lblStudentId" Visible="false"  runat="server" Text='<%# Eval("Student_Id") %>'></asp:Label>
                                                        
                                                        
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Student Name(Local)" SortExpression="Student_L">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblgvStudentNameL" runat="server" Text='<%# Eval("Student_L") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle CssClass="grid" />
                                                </asp:TemplateField>
                                            </Columns>
