    <%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="TemporaryShift.aspx.cs" Inherits="Attendance_TemporaryShift" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Temporary Shift %>"
   ...
   <asp:RadioButton ID="rbtnEmp" runat="server" CssClass="labelComman" AutoPostBack="true" Text="<%$ Resources:Attendance,Employee %>"
                                                    ...
                                                    <asp:UpdatePanel ID="updt1" runat="server">
                                                        <ContentTemplate>
                                                                    ...
                                                                    <tr>
                                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                            <asp:Panel ID="pnlemployee" runat="server" Height="300px" ScrollBars="Both" Width="100%"
                                                                                ...
                                                                                <asp:Panel ID="pnlfilter" runat="server"  style="background-image: url(../Images/bg_repeat.jpg); background-repeat: repeat;"
                                                                                    Width="100%">
                                                            ...
                                                            <asp:Label ID="Label2" runat="server" CssClass="labelComman" Text="<%$ Resources:Attendance,Select Option %>"></asp:Label>
                                                                                    ...
                                                                                    <asp:DropDownList ID="ddlSelectField" runat="server"  CssClass="DropdownSearch"    Height="25px" Width="80px">
                                                                                    ...
                                                                                    <asp:DropDownList ID="ddlSelectOption" runat="server" CssClass="DropdownSearch"   Height="25px" Style="margin-left: 0px"
                                                                                        Width="100px">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtval" runat="server" CssClass="textCommanSearch" Height="14px" Width="100px"></asp:TextBox>
                                                                                    </td>
                                                                                    <td align="<%= Common.ChangeTDForDefaultLeft()%>" width="30px">
                                                                                    <asp:ImageButton
                                                                                        ID="btnEmp" runat="server" CausesValidation="False" Height="25px" ImageUrl="~/Images/search.png"
                                                                                        OnClick="btnEmp_Click" TabIndex="4" Width="25px" />
                                                                                     </td>
                                                                                     
                                                                                     <td  align="<%= Common.ChangeTDForDefaultLeft()%>" width="30px">
                                                                                        <asp:ImageButton ID="btnrefresh2"
                                                                                            runat="server" CausesValidation="False" Height="25px" ImageUrl="~/Images/refresh.png"
                                                                                            OnClick="btnRefresh2Report_Click" Width="25px" TabIndex="5"></asp:ImageButton>
                                                                                         </td>
                                                                                         </tr>
                                                                                         </table>
                                                                                         </asp:Panel>
                                                                                <asp:GridView ID="GvEmpList" runat="server" AutoGenerateColumns="False" DataKeyNames="Emp_Code"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField>
                                                                                            ...
                                                                                            <HeaderTemplate >
                                                                                                <asp:CheckBox ID="chkSelAll" runat="server" AutoPostBack="True" OnCheckedChanged="chkSelAll_CheckedChanged" /></HeaderTemplate><HeaderStyle HorizontalAlign="Left" />
                                                                                        </asp:TemplateField>
                                                                                         <asp:TemplateField HeaderText="<%$ Resources:Attendance,Employee Code %>">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEmpCode" runat="server" Text='<%# Eval("Emp_Code") %>'></asp:Label>
                                                                        ...
                                                                        <td align="<%= Common.ChangeTDForDefaultLeft()%>" >
                                                                            ...
                                                                            <asp:Panel ID="pnlEmpSel"  runat="server" Height="300px" ScrollBars="Both" Width="100%"
                                                                                DefaultButton="btnEmp0">
                                                                                 <asp:Panel ID="Panel1" runat="server"  style="background-image: url(../Images/bg_repeat.jpg); background-repeat: repeat;"
                                                                                    Width="100%">
                                                                               <table  style="padding-left: 20px;   ">
                                                    <tr>
                                                        <td width="90px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                          ...
                                                          <td width="50px" align='<%= Common.ChangeTDForDefaultLeft()%>' >
                                                                                    <asp:DropDownList ID="ddlSelectField0" CssClass="DropdownSearch"   runat="server"  Height="25px" Width="80px"    >
                                                                                        <asp:ListItem Text="<%$ Resources:Attendance,ID%>" Value="Emp_Code"></asp:ListItem>
                                                                                        <asp:ListItem Text="<%$ Resources:Attendance,Name %>" Value="Emp_Name"></asp:ListItem>
                                                                                       ...
                                                                                       <td width="50px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                                                    <asp:DropDownList ID="ddlSelectOption0" CssClass="DropdownSearch"   runat="server" Height="25px"
                                                                Width="100px"
                                                                                       >
                                                                                        <asp:ListItem Text="<%$ Resources:Attendance,--Select--%>"></asp:ListItem>
                                                                                        <asp:ListItem Text="<%$ Resources:Attendance,Equal %>" Value="Equal"></asp:ListItem>
                                                                                    ...
                                                                                    <td width="50px" align='<%= Common.ChangeTDForDefaultLeft()%>'> 
                                                                                    <asp:TextBox ID="txtval0" CssClass="textCommanSearch" Height="14px"  runat="server" Width="100px"></asp:TextBox>
                                                                                    
                                                                                    
                                                                                    </td>
                                                                                      <td  width="30px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                                                    <asp:ImageButton ID="btnEmp0" runat="server" CausesValidation="False" Height="25px" ImageUrl="~/Images/search.png"
                                                                                          OnClick="btnEmp0_Click" TabIndex="4" Width="25px" />
                                                                                        
                                                                                        </td>
                                                                                        <td width="50px" align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                                                            <asp:ImageButton ID="btnRefresh3"
                                                                                            runat="server" CausesValidation="False" Height="25px" ImageUrl="~/Images/refresh.png"
                                                                                            OnClick="btnRefresh3Report_Click" Width="25px" TabIndex="5"></asp:ImageButton>
                                                                                            </td>
                                                                                            </tr></table>
                                                                                            </asp:Panel>
                                     ...
                                     <asp:ListBox ID="lbxGroup" runat="server" Height="211px" Width="171px" SelectionMode="Multiple" AutoPostBack="true"   OnSelectedIndexChanged="lbxGroup_SelectedIndexChanged"
                                       ...
                                       <asp:GridView ID="gvEmployee" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                OnPageIndexChanging="gvEmp1_PageIndexChanging" CssClass="grid" Width="100%"
                                         ...
                                         <asp:Label ID="lblEmp" runat="server" Visible="false"></asp:Label>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Panel ID="Pnl1" runat="server" DefaultButton="btnIsTemprary">
                                                        <table style="width: 100%">
                                                            <tr>
                                                                ...
                                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>' style="width: 257px">
                                                                    <asp:TextBox ID="txtFrom" runat="server" Width="150px" CssClass="textComman"></asp:TextBox><cc1:CalendarExtender
                                                                ...
                                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>'>
                                                                    ...
                                                                    <cc1:CalendarExtender ID="txtTo_CalendarExtender"  Format="dd-MMM-yyyy"  runat="server" Enabled="True" TargetControlID="txtTo">
                                                                    </cc1:CalendarExtender>
                                                                </td>
                                                                <td align="left">
                                                                     &nbsp;&nbsp;
                                                            ...
                                                            <tr runat="server" id="trs" visible="false" >
                                                                ...
                                                                <td align='<%= Common.ChangeTDForDefaultLeft()%>' colspan="4" style="height: 23px"
                                                                    valign="top">
                                                                    <asp:DropDownList ID="ddlShift" runat="server" CssClass="DropdownSearch" Height="25px" Width="162px" 
                                                                        >
                                                                    </asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center"  colspan="5" >
                                                                   <asp:Button ID="btnIsTemprary"  runat="server" CssClass="buttonCommman" OnClick="btnIsTemprary_Click"
                                                                        Text="<%$ Resources:Attendance,Select Time Table %>" Height="23px" Width="130px"  />
                                                                      
                                                                            
                                                                            &nbsp;&nbsp;
                                                                             <asp:Button ID="btncancel1" runat="server" Text="<%$ Resources:Attendance,Cancel %>" OnClick="btnCancel1_Click"
                                                                        CssClass="buttonCommman" Width="77px" Visible="true" Height="23px" /><asp:HiddenField ID="HiddenField2"
                                                                            runat="server" />
                                                                             &nbsp;&nbsp;
                                                     ...
                                                     <asp:Button ID="btnNext" runat="server" CausesValidation="False" CssClass="buttonCommman"
                                                                Height="25px" ImageUrl="~/Images/buttonCancel.png" OnClick="btnNext1_Click"
                                                                TabIndex="4" Text="<%$ Resources:Attendance,Next %>" />
                                    ...
                                    <table width="100%" runat="server" id="tbl">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right"  >
                                                            <asp:Button ID="btnOk0" runat="server" CausesValidation="False" CssClass="buttonCommman"
                                                                ImageUrl="~/Images/buttonSave.png" OnClick="btnsaveTempShift_Click" TabIndex="2" Text="<%$ Resources:Attendance,Save %>"
                                        ...
                                        <tr id="Tr2" runat="server">
                                            ...
                                            <tr>
                                            <td>
                                            <asp:Panel ID="PnlTimeTableList" runat="server" 
                                                    Width="100%" Height="350px" ScrollBars="Vertical">
                                                    <table >
                                            ...
                                            <tr>
                                            <td>
                                            <asp:Panel ID="pnlAddDays" runat="server"  Width="100%"
                                                    Height="350px" ScrollBars="Vertical">   
                                                    <table >
                                        ...
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td style="height: 23px; background-image: url('../../zczxc.gif');" align="center"
                                                   ...
                                                   <asp:Label ID="lblschheader" runat="server" Text="<%$ Resources:Attendance,Schedule For %>"
                                                       CssClass="labelComman" ></asp:Label> : &nbsp;&nbsp;<asp:Label ID="lblempname" CssClass="labelComman" Font-Bold="true"  runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtFromDate" runat="server" CssClass="textComman"
                                                        Width="150px"></asp:TextBox><cc1:CalendarExtender ID="txtFromDate_CalendarExtender"
                                                            runat="server" Enabled="True" Format="dd-MMM-yyyy"  TargetControlID="txtFromDate">
                                                        </cc1:CalendarExtender>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtToDate" runat="server" CssClass="textComman" 
                                                        Width="150px"></asp:TextBox><cc1:CalendarExtender ID="txtToDate_CalendarExtender"
                                                            runat="server" Enabled="True" Format="dd-MMM-yyyy" TargetControlID="txtToDate">
                                                        </cc1:CalendarExtender>
                                                </td>
                                                <td>
                                                    <asp:Button Width="50px" ID="btnsubmit" runat="server" Text="<%$ Resources:Attendance,Go %>" OnClick="btnsubmit_Click"
                                                        CssClass="buttonCommman" CausesValidation="False" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td  style="padding-left:35px;"   colspan="5" >
                                                    <asp:Panel ID="Panel2" runat="server" Height="300px" ScrollBars="Both">
                                                        <asp:GridView ID="GvShiftReport"  runat="server" DataKeyNames="Att_Date,Emp_Id,OnDuty_Time,OffDuty_Time" OnRowDataBound="GvShiftreport_RowDataBound" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="<%$ Resources:Attendance,Date %>">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblDate" runat="server" Text='<%# Convert.ToDateTime(Eval("Att_Date")).ToString("dd-MMM-yyyy") %>'></asp:Label></ItemTemplate>
                                                                </asp:TemplateField>
                                                               ...
                                                               <asp:TemplateField HeaderText="<%$ Resources:Attendance,Is Holiday %>">
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="chkHoliday" runat="server" Enabled="false" />  </ItemTemplate>
                                                                </asp:TemplateField>
