<%@ Page Language="C#" MasterPageFile="~/ERPMaster.master" AutoEventWireup="true" CodeFile="LogProcess.aspx.cs" Inherits="Attendance_LogProcess" Title="Untitled Page" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px">
                                                <asp:Label ID="lblHeader" runat="server" Text="<%$ Resources:Attendance,Log Process Setup %>"
                                                        ...
                                                        <td style="padding-left:10px;" align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                ...
                                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                   ...
                                                                   <cc1:CalendarExtender 
                                                                    ID="txtFrom_CalendarExtender"  Format="dd-MMM-yyyy"  runat="server" Enabled="True" TargetControlID="txtFromDate">
                                                                </cc1:CalendarExtender>
                                                                </td>
                                                                ...
                                                                <td align="<%= Common.ChangeTDForDefaultLeft()%>">
                                                                   ...
                                                                   <cc1:CalendarExtender 
                                                                    ID="CalendarExtender1"  Format="dd-MMM-yyyy"  runat="server" Enabled="True" TargetControlID="txtToDate">
                                                                </cc1:CalendarExtender>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <asp:Button ID="btnLogProcess" Width="100px" runat="server" OnClick="btnLogProcess_Click" Text="<%$ Resources:Attendance,Log Process %>"
